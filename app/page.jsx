        ...
        <div className="flex flex-col lg:flex-row items-center justify-between lg:pt-8 lg:pb-24">
          ...
          <div className="text-center lg:text-left order-2 lg:order-none">
            ...
            <div className="h1 mb-6">
              <h1>
                Hello I`m <br />{" "}
                <span className="text-accent">Muhammad Rafay</span>{" "}
              </h1>
            </div>
            <p className="max-w-[550px] mb-9 text-white/80">
              I turn your ideas into interactive, high-performing web solutions.
              As a full stack developer, I create sleek, user-focused designs
              and powerful backends to deliver results that drive your success.
            </p>
            {/* Btn and socials */}
            <div className="flex flex-col lg:flex-row items-center gap-10">
              <Link
                href="/muhammad-rafay-saeed-fsd.pdf"
                download="Mirxa's CV"
                target="_blank"
